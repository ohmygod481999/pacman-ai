...
class ReflexAgent(Agent):
    ...
    def evaluationFunction(self, currentGameState, action):
        ...
        if len(foods) > 0:
            temp = 5 / len(foods)
        return successorGameState.getScore() + count + temp
...
class MinimaxAgent(MultiAgentSearchAgent):
    ...
    def getAction(self, gameState):
        ...
        """
        "*** YOUR CODE HERE ***"
        # numGosh = gameState.getNumAgents() - 1
        # print gameState.getLegalActions(0)
        # print gameState.generateSuccessor(0, "Left")
        ...
        def miniMax(gameState, agent, depth):
            ...
            # All ghosts have finished one round: increase depth(last ghost) #
